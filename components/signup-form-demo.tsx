...
export default function SignupFormDemo() {
  ...
  return (
    <div className="shadow-sm mx-auto w-full max-w-md rounded-none bg-[white] p-4 md:rounded-2xl md:p-8 dark:bg-black">
      <h2 className="text-xl font-bold text-neutral-800 dark:text-neutral-200">
        Welcome to {app_name}
      </h2>
      <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
        Login to {app_name} if you can because we don&apos;t have a login flow
        yet
      </p>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <button
            className="group/btn shadow-sm relative flex h-10 w-full items-center justify-center space-x-2 rounded-md bg-gray-50 px-4 font-medium text-black dark:bg-zinc-900 dark:shadow-[0px_0px_3px_1px_#262626]"
            type="submit"
          >
