    ...
    <div className='h-screen flex lg:flex-row items-center flex-col md:px-40 md:py-25 p-12'>
          ...
          <div className='flex flex-col gap-2'>
           ...
           <input type={isPasswordShow ? 'text' : 'password'}
            ...
            onChange={(e)=>setPassword(e.target.value)}
              className='py-2 px-4 rounded-lg relative w-full text-neutral-800 ring ring-offset-1 ring-neutral-500/30 shadow-md shadow-neutral-600/40 focus:ring-primary/40 focus:ring-2 outline-0'
              placeholder='z__*******'
            />
      ...
      <div className='flex flex-col gap-4 w-1/2 p-4 opacity-90 border-2 border-dashed border-neutral-300 h-full'>
        <div className='relative animated-gradient px-5 h-full w-full'>
          <div className="pointer-events-none absolute top-0 right-0 w-75 h-75">
