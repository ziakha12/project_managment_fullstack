    ...
    <div className='h-screen bg-[url(/BG.png)] bg-no-repeat bg-cover flex items-center justify-center'>
      <div className='flex flex-col gap-4 max-w-100 text-center w-full'>
        <div className="flex flex-col gap-1 text-center">
          ...
          <p className='text-md font-inter font-medium text-neutral-500 '>Already have an account ? <Link className='font-medium font-nunito underline  text-primary' href={'/login'}>Login</Link>
          </p>
        </div>
        ...
        <form className='mt-2 w-full flex flex-col gap-5' onSubmit={onLogin}>
          ...
          <div className='flex flex-col gap-2'>
            <div className="relative w-full">
              <input type={isPasswordShow ? 'text' : 'password'}
                ...
                className='py-2 w-full px-4 rounded-lg relative text-neutral-800 ring ring-offset-1 ring-neutral-500/30 shadow-md shadow-neutral-600/40 focus:ring-primary/40 focus:ring-2 outline-0'
                placeholder='z__*******'
              />
          ...
          <button type='submit' className='py-2 px-4 text-center gradient-bg text-white text-md  font-semibold font-nunito rounded-lg hover:bg-primary shadow-md shadow-neutral-600/40'>Continue</button>
        </form>
      </div>
    </div>
  )
